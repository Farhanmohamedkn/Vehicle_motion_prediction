...
class evaluation:
    ...
    def calculate_ahe(self):
        ...
        self.heading_hat = self.pred_results.iloc[:, 3 + 2 * self.predict_horizon:3 + 3 * self.predict_horizon].to_numpy()
    ...
    def get_fde_ade_ahe(self):
        ...
        return self.fde_val, self.ade_val, self.ahe_val

    def print_fde_ade_ahe(self):
        print('The average displacement error is ' + str(round(self.ade_val, 3)) + ' m')
        print('The average final displacement error is ' + str(round(self.ade_val, 3)) + 'm')
